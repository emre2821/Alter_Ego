...
pip install chromadb sentence-transformers rich typer watchdog pydantic pyyaml markdown2 requests numpy scikit-learn nltk tk pyttsx3 gpt4all
...
# STEP 7: Launch the GUI and speak with Alter/Ego
